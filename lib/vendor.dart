            ...
            Padding(
              ...
              child: Row(
                ...
                children: <Widget>[
                  ...
                  Padding(
                    padding: EdgeInsets.fromLTRB(5, 30, 0, 0),
                    child: Text("Client",style: TextStyle(fontSize: 25,fontWeight: FontWeight.bold),),
                  ),
                ],
              ),
            ),
                          ...
                          children: [
                            Padding(
                              ...
                              child: Container(
                                ...
                                child: Text('QR-Scan',style: TextStyle(fontSize: 40,color: Colors.black,fontWeight: FontWeight.bold),),
                              ),
                            ),
                              ...
                              child: Container(
                                  ...
                                  ElevatedButton(
                                    ...
                                    onPressed: () {
                                      Navigator.push(
                                        context,
                                        MaterialPageRoute(builder: (context) => ReadExampleScreen()),
                                      );
